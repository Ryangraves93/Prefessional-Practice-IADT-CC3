...
public class PathFinding : MonoBehaviour
{
    ...
    public void selectTile(int dir, int stepSize) // recursive function for player movement to check for walls and edges
    {
        ...
        if (dir == 1)
        {
            Debug.Log("Current player postiion " + grid.NodeFromWorldPoint(transform.position).worldPosition);
            ...
            {
                Debug.Log("NewNode World pos - "  + newNode.worldPosition);
